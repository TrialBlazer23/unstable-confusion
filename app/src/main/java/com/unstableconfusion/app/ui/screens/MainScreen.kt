...
fun MainScreen() {
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable("generate") {
                GenerateScreen(viewModel = generationViewModel)
            }
            composable("gallery") {
                GalleryScreen(viewModel = generationViewModel)
            }
            composable("settings") {
                SettingsScreen(viewModel = generationViewModel)
            }
        }
    }
}
...
private val bottomNavItems = listOf(
    BottomNavItem("generate", Icons.Filled.AutoAwesome, "Generate"),
